...
== Jukeboxes
* Jukebox: Allows users to be able to store their various music on the website. To set one up the user needs to buy the jukebox upgrade first. After that they will need to pay in points to create a jukebox. In additon to this the user can setup some music to give the 
jukebox a bit of flavor. Jukebox content can be restricted to various bookgroups depending on the content that it contains.
